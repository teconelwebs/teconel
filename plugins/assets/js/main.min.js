...
// Function to automate the slide movement
function autoSlide(){
  nextSlide(1); // Move to the next slide
}

// Call changeSlide initially to display the first slide
changeSlide();

// Set the slide to change every 5 seconds (5000 milliseconds)
